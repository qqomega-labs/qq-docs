...
- Renamed `static/img/QQOmega_logo_nopad.svg` in `static/img/QQOmega_logo.svg`

## [v1.0.1] - 2026-03-06 (QQAlpha,QQSigma)

- Final consistency check between docs and social posts (EN + CN)

## [Unreleased] - 2026-03-01 (QQSigma)

- Updated roadmap (EN + CN)
- Fixed CN Why section
- Updated Airdrop section (EN + CN)

## [v1.0.0] - 2026-02-28 (QQAlpha, QQSigma)

- Docs update
- Defined `v1.0.0`

## [Unreleased] - 2026-02-27 (QQAlpha, QQSigma)
...
- **CN docs path rename** (`/docs/zh/`)
  - Renamed file from `burn+pol` to `burn&POL` to force page regeneration

## [v0.2.3] - 2026-02-06 (QQAlpha, QQSigma)
