...
- There is **no guarantee** that any specific action or behavior will receive rewards.
:::
...
*Any future airdrop distributions, if they occur, are entirely discretionary. No guarantees are made regarding timing, amount, or occurrence, and no entitlement, expectation, or right to receive tokens is created.*
