...
- generate **per-area scores** for Fundamentals, Tokenomics, On-chain, Technical Analysis, and Macro,  
- compute a **global QQ Score** for each asset or strategy while **incorporating market cap weighting**,  
