...
In QQ Omega, **Hydrogen** plays a similar role for **on-chain behavior**: it shows who really holds a token, how capital moves between actors, and how these flows change over time.
...
Another set of agents maps **who the key holders are**, classifying them into clear categories, such as CEXs, companies, institutions, investors, smart contracts, dead wallets, and unknown whales, and watching how their positions evolve over **24h, 7d, and 30d**.
...
- **Volumes: how fast value circulates**  
  ...
  - Trading volumes on DEXs (spot and perpetuals where visible on-chain)  
...
- **Holder Dynamics: who is accumulating or distributing**  
  Another agent tracks **changes in balances** across the same clusters over the last **24h / 7d / 30d**.
  It looks at:
...
The Hydrogen swarm forms the **behavioral layer** of QQ Omega’s scoring and decision system.  
